...
def test_Blur_inputs():
    ...
    fwhm3d=dict(argstr='-3dfwhm %s %s %s',
    mandatory=True,
    xor=('fwhm', 'fwhm3d', 'standard_dev'),
    ),
    gaussian=dict(argstr='-gaussian',
    xor=('gaussian', 'rect'),
    ),
    ...
    output_file_base=dict(argstr='%s',
    hash_files=False,
...
def test_Blur_outputs():
    output_map = dict(gradient_dxyz=dict(),
    output_file=dict(),
    partial_dx=dict(),
    partial_dxyz=dict(),
    partial_dy=dict(),
