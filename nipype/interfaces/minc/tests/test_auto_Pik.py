...
def test_Pik_inputs():
    input_map = dict(
        ...
        args=dict(argstr="%s"),
        auto_range=dict(argstr="--auto_range", xor=("image_range", "auto_range")),
        ...
        image_range=dict(
            argstr="--image_range %s %s", xor=("image_range", "auto_range")
        ),
        ...
        scale=dict(argstr="--scale %s", usedefault=True),
        slice_x=dict(argstr="-x", xor=("slice_z", "slice_y", "slice_x")),
        slice_y=dict(argstr="-y", xor=("slice_z", "slice_y", "slice_x")),
        slice_z=dict(argstr="-z", xor=("slice_z", "slice_y", "slice_x")),
        start=dict(argstr="--slice %s"),
        tile_size=dict(argstr="--tilesize %s"),
        title=dict(argstr="%s"),
        title_size=dict(argstr="--title_size %s", requires=["title"]),
