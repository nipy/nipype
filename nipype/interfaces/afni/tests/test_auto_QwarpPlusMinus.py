...
def test_QwarpPlusMinus_inputs():
    input_map = dict(
        ...
        allineate_opts=dict(argstr="-allineate_opts %s", requires=["allineate"]),
        allsave=dict(argstr="-allsave", xor=["nopadWARP", "duplo", "plusminus"]),
        args=dict(argstr="%s"),
        ballopt=dict(argstr="-ballopt", xor=["workhard", "boxopt"]),
        base_file=dict(
            argstr="-base %s", copyfile=False, extensions=None, mandatory=True
        ),
        baxopt=dict(argstr="-boxopt", xor=["workhard", "ballopt"]),
        blur=dict(argstr="-blur %s"),
        duplo=dict(
            argstr="-duplo",
            xor=["gridlist", "maxlev", "inilev", "iniwarp", "plusminus", "allsave"],
        ),
        emask=dict(argstr="-emask %s", copyfile=False, extensions=None),
        environ=dict(nohash=True, usedefault=True),
        expad=dict(argstr="-expad %d", xor=["nopadWARP"]),
        gridlist=dict(
            argstr="-gridlist %s",
            copyfile=False,
            extensions=None,
        ...
        hel=dict(argstr="-hel", xor=["nmi", "mi", "lpc", "lpa", "pear"]),
        in_file=dict(
            argstr="-source %s", copyfile=False, extensions=None, mandatory=True
        ),
        inilev=dict(argstr="-inilev %d", xor=["duplo"]),
        iniwarp=dict(argstr="-iniwarp %s", xor=["duplo"]),
        iwarp=dict(argstr="-iwarp", xor=["plusminus"]),
        lpa=dict(argstr="-lpa", xor=["nmi", "mi", "lpc", "hel", "pear"]),
        lpc=dict(argstr="-lpc", position=-2, xor=["nmi", "mi", "hel", "lpa", "pear"]),
        maxlev=dict(argstr="-maxlev %d", position=-1, xor=["duplo"]),
        mi=dict(argstr="-mi", xor=["mi", "hel", "lpc", "lpa", "pear"]),
        minpatch=dict(argstr="-minpatch %d"),
        nmi=dict(argstr="-nmi", xor=["nmi", "hel", "lpc", "lpa", "pear"]),
        ...
        nopadWARP=dict(argstr="-nopadWARP", xor=["allsave", "expad"]),
        nopenalty=dict(argstr="-nopenalty"),
        nowarp=dict(argstr="-nowarp"),
        noweight=dict(argstr="-noweight"),
        num_threads=dict(nohash=True, usedefault=True),
        out_file=dict(
            argstr="-prefix %s", extensions=None, position=0, usedefault=True
        ),
        out_weight_file=dict(argstr="-wtprefix %s", extensions=None),
        outputtype=dict(),
