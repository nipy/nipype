...
class MaskaveInputSpec(AFNICommandInputSpec):
    in_file = File(desc='input file to 3dmaskave',
                   ...
                   exists=True)
    out_file = File(
        name_template="%s_maskave.1D", desc='output image file name',
        keep_extension=True,
...
class SkullStripInputSpec(AFNICommandInputSpec):
    in_file = File(desc='input file to 3dSkullStrip',
                   ...
                   exists=True)
    out_file = File(
        name_template="%s_skullstrip", desc='output image file name',
        argstr='-prefix %s', name_source="in_file")
...
class BlurInMaskInputSpec(AFNICommandInputSpec):
    in_file = File(
        ...
        exists=True)
    out_file = File(
        name_template='%s_blur', desc='output to the file', argstr='-prefix %s',
