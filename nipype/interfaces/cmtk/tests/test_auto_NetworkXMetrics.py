...
def test_NetworkXMetrics_inputs():
    input_map = dict(
        ...
        out_edge_metrics_matlab=dict(extensions=None, genfile=True,),
        out_global_metrics_matlab=dict(extensions=None, genfile=True,),
        out_k_core=dict(extensions=None, usedefault=True,),
        out_k_crust=dict(extensions=None, usedefault=True,),
        out_k_shell=dict(extensions=None, usedefault=True,),
        out_node_metrics_matlab=dict(extensions=None, genfile=True,),
        out_pickled_extra_measures=dict(extensions=None, usedefault=True,),
