...
def test_Segment_inputs():
    input_map = dict(
        ...
        data=dict(copyfile=False, field="data", mandatory=True),
        gaussians_per_class=dict(field="opts.ngaus"),
        gm_output_type=dict(field="output.GM"),
        mask_image=dict(extensions=None, field="opts.msk"),
        matlab_cmd=dict(),
...
def test_Segment_outputs():
    output_map = dict(
        ...
        modulated_input_image=dict(
            deprecated="0.10", extensions=None, new_name="bias_corrected_image"
        ),
