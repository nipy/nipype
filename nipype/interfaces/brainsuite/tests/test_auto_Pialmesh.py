...
def test_Pialmesh_inputs():
    ...
    laplacianSmoothing=dict(argstr='--smooth %f',
    usedefault=True,
    ),
    maxThickness=dict(argstr='--max %f',
    usedefault=True,
    ),
    normalSmoother=dict(argstr='--nc %f',
    usedefault=True,
    ),
    numIterations=dict(argstr='-n %d',
    usedefault=True,
    ),
    outputInterval=dict(argstr='--interval %d',
    usedefault=True,
    ),
    ...
    searchRadius=dict(argstr='-r %f',
    usedefault=True,
    ),
    stepSize=dict(argstr='-s %f',
    usedefault=True,
    ),
    ...
    tissueThreshold=dict(argstr='-t %f',
    usedefault=True,
    ),
