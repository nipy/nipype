...
def test_Pialmesh_inputs():
    input_map = dict(
        ...
        laplacianSmoothing=dict(argstr="--smooth %f", usedefault=True),
        maxThickness=dict(argstr="--max %f", usedefault=True),
        normalSmoother=dict(argstr="--nc %f", usedefault=True),
        numIterations=dict(argstr="-n %d", usedefault=True),
        outputInterval=dict(argstr="--interval %d", usedefault=True),
        outputSurfaceFile=dict(argstr="-o %s", extensions=None, genfile=True),
        recomputeNormals=dict(argstr="--norm"),
        searchRadius=dict(argstr="-r %f", usedefault=True),
        stepSize=dict(argstr="-s %f", usedefault=True),
        tangentSmoother=dict(argstr="--tc %f"),
        timer=dict(argstr="--timer"),
        tissueThreshold=dict(argstr="-t %f", usedefault=True),
