...
def test_BDP_inputs():
    input_map = dict(
        ...
        customDiffusionLabel=dict(
            argstr="--custom-diffusion-label %s", extensions=None
        ),
        customLabelXML=dict(argstr="--custom-label-xml %s", extensions=None),
        customT1Label=dict(argstr="--custom-t1-label %s", extensions=None),
        ...
        dwiMask=dict(argstr="--dwi-mask %s", extensions=None),
        ...
        fieldmapCorrection=dict(
            argstr="--fieldmap-correction %s", extensions=None, requires=["echoSpacing"]
        ),
        fieldmapCorrectionMethod=dict(
            argstr="--fieldmap-correction-method %s", xor=["skipIntensityCorr"]
        ),
        fieldmapSmooth=dict(argstr="--fieldmap-smooth3=%f"),
        flagConfigFile=dict(argstr="--flag-conf-file %s", extensions=None),
        ...
        inputDiffusionData=dict(
            argstr="--nii %s", extensions=None, mandatory=True, position=-2
        ),
        ...
        t1Mask=dict(argstr="--t1-mask %s", extensions=None),
        threads=dict(argstr="--threads=%d"),
        transformDataOnly=dict(argstr="--transform-data-only"),
        transformDiffusionSurface=dict(
            argstr="--transform-diffusion-surface %s", extensions=None
        ),
        transformDiffusionVolume=dict(
            argstr="--transform-diffusion-volume %s", extensions=None
        ),
        transformInterpolation=dict(argstr="--transform-interpolation %s"),
        transformT1Surface=dict(argstr="--transform-t1-surface %s", extensions=None),
        transformT1Volume=dict(argstr="--transform-t1-volume %s", extensions=None),
    )
