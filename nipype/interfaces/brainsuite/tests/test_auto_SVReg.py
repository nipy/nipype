...
def test_SVReg_inputs():
    input_map = dict(
        args=dict(argstr="%s"),
        atlasFilePrefix=dict(argstr="'%s'", position=1),
        ...
        subjectFilePrefix=dict(argstr="'%s'", mandatory=True, position=0),
        ...
        verbosity0=dict(argstr="'-v0'", xor=("verbosity0", "verbosity1", "verbosity2")),
        verbosity1=dict(argstr="'-v1'", xor=("verbosity0", "verbosity1", "verbosity2")),
        verbosity2=dict(argstr="'v2'", xor=("verbosity0", "verbosity1", "verbosity2")),
    )
