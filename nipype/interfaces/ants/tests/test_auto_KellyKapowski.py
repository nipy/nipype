...
def test_KellyKapowski_inputs():
    input_map = dict(
        args=dict(argstr="%s",),
        convergence=dict(argstr='--convergence "%s"', usedefault=True,),
        ...
        gradient_step=dict(argstr="--gradient-step %f", usedefault=True,),
        gray_matter_label=dict(usedefault=True,),
        gray_matter_prob_image=dict(
            argstr='--gray-matter-probability-image "%s"', extensions=None,
        ),
        ...
        number_integration_points=dict(
            argstr="--number-of-integration-points %d", usedefault=True,
        ),
        segmentation_image=dict(
            argstr='--segmentation-image "%s"', extensions=None, mandatory=True,
        ),
        smoothing_variance=dict(argstr="--smoothing-variance %f", usedefault=True,),
        smoothing_velocity_field=dict(
            argstr="--smoothing-velocity-field-parameter %f", usedefault=True,
        ),
        thickness_prior_estimate=dict(
            argstr="--thickness-prior-estimate %f", usedefault=True,
        ),
        thickness_prior_image=dict(
            argstr='--thickness-prior-image "%s"', extensions=None,
        ),
        ...
        white_matter_prob_image=dict(
            argstr='--white-matter-probability-image "%s"', extensions=None,
        ),
    )
