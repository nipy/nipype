...
def test_ANTS_inputs():
    ...
    delta_time=dict(requires=[u'number_of_time_steps'],
    ),
    ...
    gradient_step_length=dict(requires=[u'transformation_model'],
    ),
    ...
    metric_weight=dict(requires=[u'metric'],
    ),
    ...
    number_of_time_steps=dict(requires=[u'gradient_step_length'],
    ),
    output_transform_prefix=dict(argstr='--output-naming %s',
    mandatory=True,
    usedefault=True,
    ),
    radius=dict(requires=[u'metric'],
    ),
    regularization=dict(argstr='%s',
    ),
    regularization_deformation_field_sigma=dict(requires=[u'regularization'],
    ),
    regularization_gradient_field_sigma=dict(requires=[u'regularization'],
    ),
    ...
    symmetry_type=dict(requires=[u'delta_time'],
    ),
