...
def test_ANTS_inputs():
    input_map = dict(
        affine_gradient_descent_option=dict(
            argstr="%s",
        ),
        args=dict(
            argstr="%s",
        ...
        gradient_step_length=dict(
            requires=["transformation_model"],
        ),
        metric=dict(
            mandatory=True,
        ),
        ...
        number_of_time_steps=dict(
            requires=["gradient_step_length"],
        ),
