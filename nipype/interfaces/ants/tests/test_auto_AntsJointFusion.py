...
def test_AntsJointFusion_inputs():
    ...
    out_atlas_voting_weight_name_format=dict(requires=[u'out_label_fusion', u'out_intensity_fusion_name_format', u'out_label_post_prob_name_format'],
    ),
    ...
    out_label_post_prob_name_format=dict(requires=[u'out_label_fusion', u'out_intensity_fusion_name_format'],
    ),
    ...
    requires=[u'atlas_segmentation_image'],
    usedefault=True,
    ),
