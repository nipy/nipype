...
from ..preprocess import MotionCorr


def test_MotionCorr_inputs():
    ...
    shrink_factors=dict(argstr='-f %s',
    sep='x',
    ),
    smoothing_sigmas=dict(argstr='-s %s',
    sep='x',
    ),
...
def test_MotionCorr_outputs():
    ...
    outputs = MotionCorr.output_spec()
