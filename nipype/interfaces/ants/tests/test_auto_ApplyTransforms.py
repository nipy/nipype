...
def test_ApplyTransforms_inputs():
    input_map = dict(
        args=dict(argstr="%s"),
        default_value=dict(argstr="--default-value %g", usedefault=True),
        dimension=dict(argstr="--dimensionality %d"),
        environ=dict(nohash=True, usedefault=True),
        float=dict(argstr="--float %d", usedefault=True),
        input_image=dict(argstr="--input %s", extensions=None, mandatory=True),
        ...
        output_image=dict(argstr="--output %s", genfile=True, hash_files=False),
        print_out_composite_warp_file=dict(requires=["output_image"]),
        reference_image=dict(
            argstr="--reference-image %s", extensions=None, mandatory=True
        ),
