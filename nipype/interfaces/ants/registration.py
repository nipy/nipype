...
class RegistrationInputSpec(ANTSCommandInputSpec):
    ...
    metric = traits.List(traits.Enum("CC", "MeanSquares", "Demons", "GC", "MI", "Mattes"), mandatory=True, desc='')
    ...
    sampling_strategy = traits.List(trait=traits.Enum("Dense","Regular", "Random", None), value=['Dense'], minlen=1,
    ...
    collapse_output_transforms = traits.Bool(argstr='--collapse-output-transforms %d', default=False,
...
class RegistrationOutputSpec(TraitedSpec):
    forward_transforms = traits.List(File(), desc='List of output transforms for forward registration')
    reverse_transforms = traits.List(File(), desc='List of output transforms for reverse registration')
    ...
    inverse_composite_transform = traits.List(File(), desc='Inverse composite transform file')
...
Test collapse transforms flag
    ...
    {'reverse_invert_flags': [True, False], 'inverse_composite_transform': ['...nipype/nipype/testing/data/output_InverseComposite.h5'], 'forward_invert_flags': [False, False], 'reverse_transforms': ['...nipype/nipype/testing/data/output_0Affine.mat', '...nipype/nipype/testing/data/output_0InverseWarp.nii.gz'], 'composite_transform': ['...nipype/nipype/testing/data/output_Composite.h5'], 'forward_transforms': ['...nipype/nipype/testing/data/output_0Affine.mat', '...nipype/nipype/testing/data/output_0Warp.nii.gz']}
