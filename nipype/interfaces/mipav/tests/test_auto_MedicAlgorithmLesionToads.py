...
def test_MedicAlgorithmLesionToads_inputs():
    input_map = dict(
        ...
        inAtlas2=dict(argstr="--inAtlas2 %s", extensions=None),
        inAtlas3=dict(argstr="--inAtlas3 %s", extensions=None),
        inAtlas4=dict(argstr="--inAtlas4 %s", extensions=None),
        ...
        inFLAIR=dict(argstr="--inFLAIR %s", extensions=None),
        ...
        inT1_MPRAGE=dict(argstr="--inT1_MPRAGE %s", extensions=None),
        inT1_SPGR=dict(argstr="--inT1_SPGR %s", extensions=None),
        null=dict(argstr="--null %s"),
        outCortical=dict(argstr="--outCortical %s", hash_files=False),
        outFilled=dict(argstr="--outFilled %s", hash_files=False),
        outHard=dict(argstr="--outHard %s", hash_files=False),
        outHard2=dict(argstr="--outHard2 %s", hash_files=False),
        outInhomogeneity=dict(argstr="--outInhomogeneity %s", hash_files=False),
        outLesion=dict(argstr="--outLesion %s", hash_files=False),
        outMembership=dict(argstr="--outMembership %s", hash_files=False),
        outSulcal=dict(argstr="--outSulcal %s", hash_files=False),
        outWM=dict(argstr="--outWM %s", hash_files=False),
