...
def test_JistBrainMp2rageSkullStripping_inputs():
    input_map = dict(
        ...
        inFilter=dict(argstr="--inFilter %s", extensions=None,),
        inSecond=dict(argstr="--inSecond %s", extensions=None,),
        inSkip=dict(argstr="--inSkip %s",),
        inT1=dict(argstr="--inT1 %s", extensions=None,),
        inT1weighted=dict(argstr="--inT1weighted %s", extensions=None,),
        null=dict(argstr="--null %s",),
        outBrain=dict(argstr="--outBrain %s", hash_files=False,),
        outMasked=dict(argstr="--outMasked %s", hash_files=False,),
        outMasked2=dict(argstr="--outMasked2 %s", hash_files=False,),
        outMasked3=dict(argstr="--outMasked3 %s", hash_files=False,),
