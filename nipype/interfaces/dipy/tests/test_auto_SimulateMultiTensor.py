...
def test_SimulateMultiTensor_inputs():
    input_map = dict(
        baseline=dict(extensions=None, mandatory=True),
        ...
        out_bval=dict(extensions=None, usedefault=True),
        out_bvec=dict(extensions=None, usedefault=True),
        out_file=dict(extensions=None, usedefault=True),
        out_mask=dict(extensions=None, usedefault=True),
