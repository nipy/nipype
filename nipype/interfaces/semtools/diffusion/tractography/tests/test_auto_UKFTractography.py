...
def test_UKFTractography_inputs():
    input_map = dict(
        ...
        seedsFile=dict(argstr="--seedsFile %s", extensions=None),
        seedsPerVoxel=dict(argstr="--seedsPerVoxel %d"),
        stepLength=dict(argstr="--stepLength %f"),
        storeGlyphs=dict(argstr="--storeGlyphs "),
        tracts=dict(argstr="--tracts %s", hash_files=False),
        tractsWithSecondTensor=dict(
            argstr="--tractsWithSecondTensor %s", hash_files=False
        ),
...
def test_UKFTractography_outputs():
    output_map = dict(
        tracts=dict(extensions=None), tractsWithSecondTensor=dict(extensions=None)
    )
