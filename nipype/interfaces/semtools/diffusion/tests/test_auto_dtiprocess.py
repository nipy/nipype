...
def test_dtiprocess_inputs():
    ...
    RD_output=dict(argstr='--RD_output %s',
    hash_files=False,
    ),
    ...
    color_fa_output=dict(argstr='--color_fa_output %s',
    hash_files=False,
    ),
    correction=dict(argstr='--correction %s',
    ),
    deformation_output=dict(argstr='--deformation_output %s',
    hash_files=False,
    ),
    ...
    fa_gradmag_output=dict(argstr='--fa_gradmag_output %s',
    hash_files=False,
    ),
    fa_output=dict(argstr='--fa_output %s',
    hash_files=False,
    ),
    forward=dict(argstr='--forward %s',
    ),
    frobenius_norm_output=dict(argstr='--frobenius_norm_output %s',
    hash_files=False,
    ),
    ...
    lambda1_output=dict(argstr='--lambda1_output %s',
    hash_files=False,
    ),
    lambda2_output=dict(argstr='--lambda2_output %s',
    hash_files=False,
    ),
    lambda3_output=dict(argstr='--lambda3_output %s',
    hash_files=False,
    ),
    mask=dict(argstr='--mask %s',
    ),
    md_output=dict(argstr='--md_output %s',
    hash_files=False,
    ),
    negative_eigenvector_output=dict(argstr='--negative_eigenvector_output %s',
    hash_files=False,
    ),
    ...
    principal_eigenvector_output=dict(argstr='--principal_eigenvector_output %s',
    hash_files=False,
    ),
    reorientation=dict(argstr='--reorientation %s',
    ),
    rot_output=dict(argstr='--rot_output %s',
    hash_files=False,
    ),
