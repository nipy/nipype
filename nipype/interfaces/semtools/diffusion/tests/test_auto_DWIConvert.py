...
def test_DWIConvert_inputs():
    input_map = dict(
        ...
        fslNIFTIFile=dict(argstr="--fslNIFTIFile %s", extensions=None),
        gradientVectorFile=dict(argstr="--gradientVectorFile %s", hash_files=False),
        inputBValues=dict(argstr="--inputBValues %s", extensions=None),
        inputBVectors=dict(argstr="--inputBVectors %s", extensions=None),
        inputDicomDirectory=dict(argstr="--inputDicomDirectory %s"),
        inputVolume=dict(argstr="--inputVolume %s", extensions=None),
        outputBValues=dict(argstr="--outputBValues %s", hash_files=False),
        outputBVectors=dict(argstr="--outputBVectors %s", hash_files=False),
