...
def test_BRAINSFit_inputs():
    input_map = dict(
        ...
        fixedVolume2=dict(argstr="--fixedVolume2 %s", extensions=None,),
        ...
        movingVolume2=dict(argstr="--movingVolume2 %s", extensions=None,),
        ...
        outputFixedVolumeROI=dict(
            argstr="--outputFixedVolumeROI %s", hash_files=False,
        ),
        outputMovingVolumeROI=dict(
            argstr="--outputMovingVolumeROI %s", hash_files=False,
        ),
        ...
        strippedOutputTransform=dict(
            argstr="--strippedOutputTransform %s", hash_files=False,
        ),
