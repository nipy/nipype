...
def test_BRAINSDemonWarp_inputs():
    input_map = dict(
        ...
        arrayOfPyramidLevelIterations=dict(
            argstr="--arrayOfPyramidLevelIterations %s", sep=","
        ),
        backgroundFillValue=dict(argstr="--backgroundFillValue %d"),
        checkerboardPatternSubdivisions=dict(
            argstr="--checkerboardPatternSubdivisions %s", sep=","
        ),
        environ=dict(nohash=True, usedefault=True),
        fixedBinaryVolume=dict(argstr="--fixedBinaryVolume %s", extensions=None),
        ...
        initializeWithDisplacementField=dict(
            argstr="--initializeWithDisplacementField %s", extensions=None
        ),
        initializeWithTransform=dict(
            argstr="--initializeWithTransform %s", extensions=None
        ),
        ...
        movingBinaryVolume=dict(argstr="--movingBinaryVolume %s", extensions=None),
        ...
        outputCheckerboardVolume=dict(
            argstr="--outputCheckerboardVolume %s", hash_files=False
        ),
        ...
        outputDisplacementFieldVolume=dict(
            argstr="--outputDisplacementFieldVolume %s", hash_files=False
        ),
