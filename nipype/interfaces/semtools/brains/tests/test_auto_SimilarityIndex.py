...
def test_SimilarityIndex_inputs():
    input_map = dict(
        ANNContinuousVolume=dict(argstr="--ANNContinuousVolume %s", extensions=None),
        args=dict(argstr="%s"),
        environ=dict(nohash=True, usedefault=True),
        inputManualVolume=dict(argstr="--inputManualVolume %s", extensions=None),
        outputCSVFilename=dict(argstr="--outputCSVFilename %s", extensions=None),
