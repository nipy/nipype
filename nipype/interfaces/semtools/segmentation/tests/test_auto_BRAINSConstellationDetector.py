...
def test_BRAINSConstellationDetector_inputs():
    input_map = dict(
        ...
        args=dict(argstr="%s"),
        atlasLandmarkWeights=dict(argstr="--atlasLandmarkWeights %s", extensions=None),
        atlasLandmarks=dict(argstr="--atlasLandmarks %s", extensions=None),
        atlasVolume=dict(argstr="--atlasVolume %s", extensions=None),
        cutOutHeadInOutputVolume=dict(argstr="--cutOutHeadInOutputVolume "),
        debug=dict(argstr="--debug "),
        environ=dict(nohash=True, usedefault=True),
        forceACPoint=dict(argstr="--forceACPoint %s", sep=","),
        forceHoughEyeDetectorReportFailure=dict(
            argstr="--forceHoughEyeDetectorReportFailure "
        ),
        forcePCPoint=dict(argstr="--forcePCPoint %s", sep=","),
        forceRPPoint=dict(argstr="--forceRPPoint %s", sep=","),
        forceVN4Point=dict(argstr="--forceVN4Point %s", sep=","),
        houghEyeDetectorMode=dict(argstr="--houghEyeDetectorMode %d"),
        inputLandmarksEMSP=dict(argstr="--inputLandmarksEMSP %s", extensions=None),
        ...
        outputLandmarksInACPCAlignedSpace=dict(
            argstr="--outputLandmarksInACPCAlignedSpace %s", hash_files=False
        ),
        outputLandmarksInInputSpace=dict(
            argstr="--outputLandmarksInInputSpace %s", hash_files=False
        ),
        outputMRML=dict(argstr="--outputMRML %s", hash_files=False),
        ...
        outputUntransformedClippedVolume=dict(
            argstr="--outputUntransformedClippedVolume %s", hash_files=False
        ),
        outputVerificationScript=dict(
            argstr="--outputVerificationScript %s", hash_files=False
        ),
        ...
        writeBranded2DImage=dict(argstr="--writeBranded2DImage %s", hash_files=False),
