...
def test_MeshFix_inputs():
    ...
    requires=[u'finetuning_substeps'],
    ),
    finetuning_inwards=dict(argstr='--fineTuneIn ',
    requires=[u'finetuning_distance', u'finetuning_substeps'],
    ),
    finetuning_outwards=dict(argstr='--fineTuneIn ',
    requires=[u'finetuning_distance', u'finetuning_substeps'],
    xor=[u'finetuning_inwards'],
    ),
    ...
    xor=[u'save_as_vrml', u'save_as_stl'],
    ),
    save_as_stl=dict(argstr='--stl',
    xor=[u'save_as_vmrl', u'save_as_freesurfer_mesh'],
    ),
    save_as_vmrl=dict(argstr='--wrl',
    xor=[u'save_as_stl', u'save_as_freesurfer_mesh'],
    ),
    ...
    requires=[u'uniform_remeshing_vertices'],
    ),
    uniform_remeshing_vertices=dict(argstr='--vertices %d',
    requires=[u'uniform_remeshing_steps'],
    ),
