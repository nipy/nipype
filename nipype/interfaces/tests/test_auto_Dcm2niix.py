...
def test_Dcm2niix_inputs():
    input_map = dict(
        anon_bids=dict(argstr="-ba", requires=["bids_format"]),
        args=dict(argstr="%s"),
        bids_format=dict(argstr="-b", usedefault=True),
        comment=dict(argstr="-c %s"),
        compress=dict(argstr="-z %s", usedefault=True),
        compression=dict(argstr="-%d"),
        crop=dict(argstr="-x", usedefault=True),
        environ=dict(nohash=True, usedefault=True),
        has_private=dict(argstr="-t", usedefault=True),
        ignore_deriv=dict(argstr="-i"),
        merge_imgs=dict(argstr="-m", usedefault=True),
        out_filename=dict(argstr="-f %s"),
        output_dir=dict(argstr="-o %s", usedefault=True),
        philips_float=dict(argstr="-p"),
        series_numbers=dict(argstr="-n %s..."),
        single_file=dict(argstr="-s", usedefault=True),
        source_dir=dict(argstr="%s", mandatory=True, position=-1, xor=["source_names"]),
        source_names=dict(
            argstr="%s", copyfile=False, mandatory=True, position=-1, xor=["source_dir"]
        ),
