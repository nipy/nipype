...
def test_VtkStreamlines_inputs():
    input_map = dict(
        ...
        scalar_file=dict(argstr="-scalarfile %s", extensions=None, position=3),
        seed_file=dict(argstr="-seedfile %s", extensions=None, position=1),
        target_file=dict(argstr="-targetfile %s", extensions=None, position=2),
