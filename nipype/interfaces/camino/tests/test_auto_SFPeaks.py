...
def test_SFPeaks_inputs():
    input_map = dict(
        args=dict(argstr="%s"),
        density=dict(argstr="-density %d", units="NA"),
        environ=dict(nohash=True, usedefault=True),
        in_file=dict(argstr="-inputfile %s", extensions=None, mandatory=True),
        inputmodel=dict(argstr="-inputmodel %s", mandatory=True),
        ...
        pdthresh=dict(argstr="-pdthresh %f", units="NA"),
        pointset=dict(argstr="-pointset %d", units="NA"),
        rbfpointset=dict(argstr="-rbfpointset %d", units="NA"),
        scheme_file=dict(argstr="%s", extensions=None),
        searchradius=dict(argstr="-searchradius %f", units="NA"),
        stdsfrommean=dict(argstr="-stdsfrommean %f", units="NA"),
    )
