...
class CheckerBoardInputSpec(CommandLineInputSpec):
    ...
    inputVolume1 = File(position="0", desc="First Input volume", exists=True, argstr="%s")
    inputVolume2 = File(position="1", desc="Second Input volume", exists=True, argstr="%s")
    outputVolume = traits.Either(traits.Bool, File(), position="2", hash_files=False, desc="Output filtered", argstr="%s")
