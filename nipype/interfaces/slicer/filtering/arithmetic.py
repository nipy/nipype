...
class MultiplyScalarVolumes(SlicerCommandLine):
...
class MaskScalarVolume(SlicerCommandLine):
...
class SubtractScalarVolumes(SlicerCommandLine):
...
class AddScalarVolumes(SlicerCommandLine):
...
class CastScalarVolume(SlicerCommandLine):
