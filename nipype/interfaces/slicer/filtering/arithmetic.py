...
class CastInputSpec(CommandLineInputSpec):
    InputVolume = File(position="0", desc="Input volume, the volume to cast.", exists=True, argstr="%s")
...
class AddInputSpec(CommandLineInputSpec):
    inputVolume1 = File(position="0", desc="Input volume 1", exists=True, argstr="%s")
    inputVolume2 = File(position="1", desc="Input volume 2", exists=True, argstr="%s")
    outputVolume = traits.Either(traits.Bool, File(), position="2", hash_files=False, desc="Volume1 + Volume2", argstr="%s")
