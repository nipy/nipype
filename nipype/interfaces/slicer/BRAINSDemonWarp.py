...
class BRAINSDemonWarpInputSpec(CommandLineInputSpec):
    ...
    minimumFixedPyramid = traits.List(traits.Int, sep = ",",argstr = "--minimumFixedPyramid %s")
    minimumMovingPyramid = traits.List(traits.Int, sep = ",",argstr = "--minimumMovingPyramid %s")
    arrayOfPyramidLevelIterations = traits.List(traits.Int, sep = ",",argstr = "--arrayOfPyramidLevelIterations %s")
    ...
    seedForBOBF = traits.List(traits.Int, sep = ",",argstr = "--seedForBOBF %s")
    neighborhoodForBOBF = traits.List(traits.Int, sep = ",",argstr = "--neighborhoodForBOBF %s")
    ...
    checkerboardPatternSubdivisions = traits.List(traits.Int, sep = ",",argstr = "--checkerboardPatternSubdivisions %s")
