...
class MultiResolutionAffineRegistration(SlicerCommandLine):
...
class RigidRegistration(SlicerCommandLine):
...
class LinearRegistration(SlicerCommandLine):
...
class ExpertAutomatedRegistration(SlicerCommandLine):
