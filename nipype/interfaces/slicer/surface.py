...
class MergeModels(SlicerCommandLine):
    """title: Merge Models
...
class ModelToLabelMap(SlicerCommandLine):
...
class GrayscaleModelMaker(SlicerCommandLine):
...
class LabelMapSmoothing(SlicerCommandLine):
...
class ModelMaker(SlicerCommandLine):
    """title: Model Maker
