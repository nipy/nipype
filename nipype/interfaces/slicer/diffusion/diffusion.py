...
class ResampleDTIVolume(SlicerCommandLine):
...
class DWIRicianLMMSEFilter(SlicerCommandLine):
...
class TractographyLabelMapSeeding(SlicerCommandLine):
...
class DWIJointRicianLMMSEFilter(SlicerCommandLine):
...
class DiffusionWeightedVolumeMasking(SlicerCommandLine):
...
class DTIimport(SlicerCommandLine):
    """title: DTIimport
...
class DWIToDTIEstimation(SlicerCommandLine):
...
class DiffusionTensorScalarMeasurements(SlicerCommandLine):
...
class DTIexport(SlicerCommandLine):
    """title: DTIexport
