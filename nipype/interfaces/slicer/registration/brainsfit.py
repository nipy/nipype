...
from nipype.interfaces.base import CommandLine, CommandLineInputSpec, SEMLikeCommandLine, TraitedSpec, File, Directory, traits, isdefined, InputMultiObject, OutputMultiObject
import os
...
class BRAINSFitInputSpec(CommandLineInputSpec):
    ...
    permitParameterVariation = InputMultiObject(
        traits.Int,
        desc=
