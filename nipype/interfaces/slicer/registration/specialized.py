...
class ACPCTransformInputSpec(CommandLineInputSpec):
    acpc = InputMultiObject(
        traits.List(traits.Float(), minlen=3, maxlen=3),
        desc=
        "ACPC line, two fiducial points, one at the anterior commissure and one at the posterior commissure.",
        argstr="--acpc %s...")
    midline = InputMultiObject(
        traits.List(traits.Float(), minlen=3, maxlen=3),
        desc=
        "The midline is a series of points defining the division between the hemispheres of the brain (the mid sagittal plane).",
        argstr="--midline %s...")
...
class FiducialRegistrationInputSpec(CommandLineInputSpec):
    ...
    outputMessage = traits.Str(
        desc="Provides more information on the output",
