...
def test_EMSegmentCommandLine_inputs():
    input_map = dict(
        ...
        generateEmptyMRMLSceneAndQuit=dict(
            argstr="--generateEmptyMRMLSceneAndQuit %s", hash_files=False
        ),
        ...
        mrmlSceneFileName=dict(argstr="--mrmlSceneFileName %s", extensions=None),
        ...
        resultMRMLSceneFileName=dict(
            argstr="--resultMRMLSceneFileName %s", hash_files=False
        ),
        resultStandardVolumeFileName=dict(
            argstr="--resultStandardVolumeFileName %s", extensions=None
        ),
        resultVolumeFileName=dict(argstr="--resultVolumeFileName %s", hash_files=False),
