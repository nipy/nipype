...
class FitGLM(BaseInterface):
    ...
    def _run_interface(self, runtime):
        ...
        for functional_run in self.inputs.functional_runs[1:]:
            ...
            timeseries = np.concatenate((timeseries,nii.get_data()), axis=3)
        ...
        nb.save(nb.Nifti1Image(glm.beta.T, nii.get_affine()), self._beta_file)
        
        self._s2_file = os.path.abspath("s2.nii")
        nb.save(nb.Nifti1Image(glm.s2.T, nii.get_affine()), self._s2_file)
