...
class FitGLMInputSpec(BaseInterfaceInputSpec):
    session_info = traits.List(
        ...
        desc=(
            ...
            "not  support multiple runs unless they are "
    ...
    hrf_model = traits.Enum(
        ...
        "FIR",
        desc=(
            "that specifies the hemodynamic response "
    ...
    drift_model = traits.Enum(
        ...
        "Blank",
        desc=(
            "string that specifies the desired drift "
    ...
    method = traits.Enum(
        ...
        "ols",
        desc=(
            "method to fit the model, ols or kalma; kalman "
...
class EstimateContrastInputSpec(BaseInterfaceInputSpec):
    ...
    beta = File(
        exists=True, desc="beta coefficients of the fitted model", mandatory=True
    )
