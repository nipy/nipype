...
def test_RegAverage_inputs():
    ...
    avg_files=dict(argstr='-avg %s',
    position=1,
    sep=' ',
    xor=['avg_lts_files', 'avg_ref_file', 'demean1_ref_file', 'demean2_ref_file', 'demean3_ref_file', 'warp_files'],
    ),
    avg_lts_files=dict(argstr='-avg_lts %s',
    position=1,
    sep=' ',
    xor=['avg_files', 'avg_ref_file', 'demean1_ref_file', 'demean2_ref_file', 'demean3_ref_file', 'warp_files'],
    ),
    avg_ref_file=dict(argstr='-avg_tran %s',
    position=1,
    requires=['warp_files'],
    xor=['avg_files', 'avg_lts_files', 'demean1_ref_file', 'demean2_ref_file', 'demean3_ref_file'],
    ),
    demean1_ref_file=dict(argstr='-demean1 %s',
    position=1,
    requires=['warp_files'],
    xor=['avg_files', 'avg_lts_files', 'avg_ref_file', 'demean2_ref_file', 'demean3_ref_file'],
    ),
    demean2_ref_file=dict(argstr='-demean2 %s',
    position=1,
    requires=['warp_files'],
    xor=['avg_files', 'avg_lts_files', 'avg_ref_file', 'demean1_ref_file', 'demean3_ref_file'],
    ),
    demean3_ref_file=dict(argstr='-demean3 %s',
    position=1,
    requires=['warp_files'],
