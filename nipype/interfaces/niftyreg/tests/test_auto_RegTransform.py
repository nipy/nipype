...
def test_RegTransform_inputs():
    input_map = dict(aff_2_rig_input=dict(argstr='-aff2rig %s',
    position=-2,
    ...
    comp_input2=dict(argstr='%s',
    position=-2,
    ),
    def_input=dict(argstr='-def %s',
    position=-2,
    ...
    flirt_2_nr_input=dict(argstr='-flirtAff2NR %s %s %s',
    position=-2,
    ...
    inv_aff_input=dict(argstr='-invAff %s',
    position=-2,
    ...
    inv_nrr_input=dict(argstr='-invNrr %s %s',
    position=-2,
    ...
    make_aff_input=dict(argstr='-makeAff %f %f %f %f %f %f %f %f %f %f %f %f',
    position=-2,
    ...
    ref1_file=dict(argstr='-ref %s',
    position=0,
    ),
    ref2_file=dict(argstr='-ref2 %s',
    position=1,
    requires=['ref1_file'],
    ),
    terminal_output=dict(nohash=True,
    ),
    upd_s_form_input=dict(argstr='-updSform %s',
    position=-3,
    ...
    upd_s_form_input2=dict(argstr='%s',
    position=-2,
