...
def test_FitAsl_inputs():
    input_map = dict(
        ...
        ir_output=dict(argstr="-IRoutput %s", extensions=None),
        ir_volume=dict(argstr="-IRvolume %s", extensions=None),
        ldd=dict(argstr="-LDD %f"),
        m0map=dict(argstr="-m0map %s", extensions=None),
        m0mape=dict(argstr="-m0mape %s", extensions=None),
        ...
        seg=dict(argstr="-seg %s", extensions=None),
        ...
        t1map=dict(argstr="-t1map %s", extensions=None),
