...
no b-vectors]'
    ...
    dti_flag = traits.Bool(
        ...
        position=4,
        xor=[
            'mono_flag', 'ivim_flag', 'ball_flag', 'ballv_flag', 'nod_flag',
            'nodv_flag'
        ])
    ...
    nod_flag = traits.Bool(
        ...
        position=4,
        xor=[
            'mono_flag', 'ivim_flag', 'dti_flag', 'ball_flag', 'ballv_flag',
            'nodv_flag'
        ])
...
identity covariance...).'
    ...
    slice_no = traits.Int(
        desc='Fit to single slice number.', argstr='-slice %d')
    voxel = traits.Tuple(
        traits.Int,
        traits.Int,
        traits.Int,
    ...
    wm_t2_val = traits.Float(
        desc='White matter T2 value [80ms].', argstr='-wmT2 %f')
...
[default with no b-vectors]'
    ...
    mono_flag = traits.Bool(
        ...
        argstr='-mono',
        xor=[
            'ivim_flag', 'dti_flag', 'dti_flag2', 'ball_flag', 'ballv_flag',
            'nod_flag', 'nodv_flag'
        ])
    ...
    ivim_flag = traits.Bool(
        ...
        argstr='-ivim',
        xor=[
            'mono_flag', 'dti_flag', 'dti_flag2', 'ball_flag', 'ballv_flag',
            'nod_flag', 'nodv_flag'
        ])
    dti_flag = traits.Bool(
        ...
        argstr='-dti',
        xor=[
            'mono_flag', 'ivim_flag', 'dti_flag2', 'ball_flag', 'ballv_flag',
            'nod_flag', 'nodv_flag'
        ])
    ...
    ball_flag = traits.Bool(
        ...
        argstr='-ball',
        xor=[
            'mono_flag', 'ivim_flag', 'dti_flag', 'dti_flag2', 'ballv_flag',
            'nod_flag', 'nodv_flag'
        ])
