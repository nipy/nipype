...
def test_MRDeGibbs_inputs():
    input_map = dict(
        args=dict(argstr="%s",),
        axes=dict(argstr="-axes %s", maxlen=2, minlen=2, sep=",", usedefault=True,),
        ...
        maxW=dict(argstr="-maxW %d", usedefault=True,),
        minW=dict(argstr="-minW %d", usedefault=True,),
        nshifts=dict(argstr="-nshifts %d", usedefault=True,),
