...
def test_ComputeTDI_inputs():
    input_map = dict(
        ...
        dixel=dict(argstr="-dixel %s", extensions=None),
        ...
        in_map=dict(argstr="-image %s", extensions=None),
        ...
        reference=dict(argstr="-template %s", extensions=None),
        stat_tck=dict(argstr="-stat_tck %s"),
        stat_vox=dict(argstr="-stat_vox %s"),
        tck_weights=dict(argstr="-tck_weights_in %s", extensions=None),
        upsample=dict(argstr="-upsample %d"),
        use_dec=dict(argstr="-dec"),
        vox_size=dict(argstr="-vox %s", sep=","),
    )
