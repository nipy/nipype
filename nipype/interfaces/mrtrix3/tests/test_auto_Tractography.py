...
def test_Tractography_inputs():
    input_map = dict(
        act_file=dict(argstr="-act %s", extensions=None),
        algorithm=dict(argstr="-algorithm %s", usedefault=True),
        ...
        n_samples=dict(argstr="-samples %d", usedefault=True),
        n_tracks=dict(argstr="-number %d", max_ver="0.4"),
        ...
        out_seeds=dict(argstr="-output_seeds %s", extensions=None, usedefault=True),
        power=dict(argstr="-power %d"),
        roi_excl=dict(argstr="-exclude %s"),
        roi_incl=dict(argstr="-include %s"),
        roi_mask=dict(argstr="-mask %s"),
        seed_dynamic=dict(argstr="-seed_dynamic %s", extensions=None),
        seed_gmwmi=dict(
            argstr="-seed_gmwmi %s", extensions=None, requires=["act_file"]
        ),
        seed_grid_voxel=dict(
            argstr="-seed_grid_per_voxel %s %d", xor=["seed_image", "seed_rnd_voxel"]
        ),
        seed_image=dict(argstr="-seed_image %s", extensions=None),
        seed_rejection=dict(argstr="-seed_rejection %s", extensions=None),
        seed_rnd_voxel=dict(
            argstr="-seed_random_per_voxel %s %d", xor=["seed_image", "seed_grid_voxel"]
        ),
        seed_sphere=dict(argstr="-seed_sphere %f,%f,%f,%f"),
        select=dict(argstr="-select %d", min_ver="3"),
