...
class FLIRT(FSLCommand):
    ...
    >>> flt.cmdline #doctest: +ELLIPSIS # doctest: +IGNORE_UNICODE
...
class FUGUE(FSLCommand):
    ...
    >>> fugue.cmdline #doctest: +ELLIPSIS # doctest: +IGNORE_UNICODE
    u'fugue --in=epi.nii --mask=epi_mask.nii --loadshift=vsm.nii --unwarpdir=y --unwarp=epi_unwarped.nii.gz'
