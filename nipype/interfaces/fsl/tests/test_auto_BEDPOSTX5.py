...
def test_BEDPOSTX5_inputs():
    input_map = dict(
        ...
        grad_dev=dict(extensions=None,),
        gradnonlin=dict(argstr="-g",),
        logdir=dict(argstr="--logdir=%s",),
        mask=dict(extensions=None, mandatory=True,),
        model=dict(argstr="-model %d",),
        n_fibres=dict(argstr="-n %d", mandatory=True, usedefault=True,),
        n_jumps=dict(argstr="-j %d", usedefault=True,),
        ...
        out_dir=dict(argstr="%s", mandatory=True, position=1, usedefault=True,),
        output_type=dict(),
        rician=dict(argstr="--rician",),
        sample_every=dict(argstr="-s %d", usedefault=True,),
