...
def test_FSLXCommand_inputs():
    input_map = dict(
        ...
        args=dict(argstr="%s",),
        burn_in=dict(argstr="--burnin=%d", usedefault=True,),
        burn_in_no_ard=dict(argstr="--burnin_noard=%d", usedefault=True,),
        bvals=dict(argstr="--bvals=%s", extensions=None, mandatory=True,),
        bvecs=dict(argstr="--bvecs=%s", extensions=None, mandatory=True,),
        cnlinear=dict(
            argstr="--cnonlinear", xor=("no_spat", "non_linear", "cnlinear"),
        ),
        dwi=dict(argstr="--data=%s", extensions=None, mandatory=True,),
        ...
        mask=dict(argstr="--mask=%s", extensions=None, mandatory=True,),
        model=dict(argstr="--model=%d",),
        n_fibres=dict(argstr="--nfibres=%d", mandatory=True, usedefault=True,),
        n_jumps=dict(argstr="--njumps=%d", usedefault=True,),
        no_ard=dict(argstr="--noard", xor=("no_ard", "all_ard"),),
        no_spat=dict(argstr="--nospat", xor=("no_spat", "non_linear", "cnlinear"),),
        non_linear=dict(
            argstr="--nonlinear", xor=("no_spat", "non_linear", "cnlinear"),
        ),
        output_type=dict(),
        rician=dict(argstr="--rician",),
        sample_every=dict(argstr="--sampleevery=%d", usedefault=True,),
        seed=dict(argstr="--seed=%d",),
        update_proposal_every=dict(argstr="--updateproposalevery=%d", usedefault=True,),
    )
