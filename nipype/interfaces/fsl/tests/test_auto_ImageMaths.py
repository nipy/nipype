...
def test_ImageMaths_inputs():
    input_map = dict(
        ...
        in_file2=dict(argstr="%s", extensions=None, position=3,),
        mask_file=dict(argstr="-mas %s", extensions=None,),
        op_string=dict(argstr="%s", position=2,),
        out_data_type=dict(argstr="-odt %s", position=-1,),
        out_file=dict(
