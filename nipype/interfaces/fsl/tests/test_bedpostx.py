...
mask_file = fsl_course_dir + "fsl_course_data/fdt/subj1.bedpostX/nodif_brain_mask.nii.gz"
bvecs_file = fsl_course_dir + "fsl_course_data/fdt/subj1/bvecs"
bvals_file = fsl_course_dir + "fsl_course_data/fdt/subj1/bvals"
...
original_bedpostx.inputs.env.update(FSLPARALLEL="")
