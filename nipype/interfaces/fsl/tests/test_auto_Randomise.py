...
def test_Randomise_inputs():
    input_map = dict(
        ...
        design_mat=dict(argstr="-d %s", extensions=None, position=2),
        environ=dict(nohash=True, usedefault=True),
        f_c_thresh=dict(argstr="-F %.2f"),
        f_cm_thresh=dict(argstr="-S %.2f"),
        f_only=dict(argstr="--fonly"),
        fcon=dict(argstr="-f %s", extensions=None),
        ...
        tcon=dict(argstr="-t %s", extensions=None, position=3),
        tfce=dict(argstr="-T"),
        ...
        x_block_labels=dict(argstr="-e %s", extensions=None),
    )
