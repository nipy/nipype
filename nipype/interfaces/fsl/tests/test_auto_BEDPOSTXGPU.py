...
from nipype.interfaces.fsl.dti import BEDPOSTXGPU

def test_BEDPOSTXGPU_inputs():
    ...
    inputs = BEDPOSTXGPU.input_spec()

    for key, metadata in input_map.items():
        for metakey, value in metadata.items():
            yield assert_equal, getattr(inputs.traits()[key], metakey), value

def test_BEDPOSTXGPU_outputs():
    ...
    outputs = BEDPOSTXGPU.output_spec()
