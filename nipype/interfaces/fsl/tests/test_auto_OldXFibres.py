...
from nipype.interfaces.fsl.dti import OldXFibres

def test_OldXFibres_inputs():
    ...
    inputs = OldXFibres.input_spec()

    for key, metadata in input_map.items():
        for metakey, value in metadata.items():
            yield assert_equal, getattr(inputs.traits()[key], metakey), value

def test_OldXFibres_outputs():
    ...
    outputs = OldXFibres.output_spec()
