...
def test_MELODIC_inputs():
    input_map = dict(
        ICs=dict(argstr="--ICs=%s", extensions=None),
        approach=dict(argstr="-a %s"),
        args=dict(argstr="%s"),
        bg_image=dict(argstr="--bgimage=%s", extensions=None),
        ...
        mix=dict(argstr="--mix=%s", extensions=None),
        ...
        s_con=dict(argstr="--Scon=%s", extensions=None),
        s_des=dict(argstr="--Sdes=%s", extensions=None),
        sep_vn=dict(argstr="--sep_vn"),
        sep_whiten=dict(argstr="--sep_whiten"),
        smode=dict(argstr="--smode=%s", extensions=None),
        t_con=dict(argstr="--Tcon=%s", extensions=None),
        t_des=dict(argstr="--Tdes=%s", extensions=None),
