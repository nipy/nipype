...
def test_TOPUP_inputs():
    ...
    encoding_direction=dict(mandatory=True,
    ...
    hash_files=False,
    mandatory=True,
    output_name='out_enc_file',
    template='{in_file}_encfile.txt',
    ...
    out_fieldcoef=dict(hash_files=False,
    ),
    out_logfile=dict(argstr='--logout=%s',
    hash_files=False,
    ),
    out_movpar=dict(hash_files=False,
    ),
