...
class RobustTemplate(FSCommand):
    ...
    >>> template.cmdline  #doctest: +NORMALIZE_WHITESPACE # doctest: +IGNORE_UNICODE
    ...
    >>> template.cmdline  #doctest: +NORMALIZE_WHITESPACE # doctest: +IGNORE_UNICODE
    u'mri_robust_template --satit --average 0 --fixtp --mov structural.nii functional.nii --inittp 1 --noit --template T1.nii --subsample 200'
    ...
    >>> template.cmdline    #doctest: +NORMALIZE_WHITESPACE # doctest: +IGNORE_UNICODE
    u'mri_robust_template --satit --average 0 --fixtp --mov structural.nii functional.nii --inittp 1 --noit --template T1.nii --iscaleout structural-iscale.txt functional-iscale.txt --subsample 200 --lta structural.lta functional.lta'
