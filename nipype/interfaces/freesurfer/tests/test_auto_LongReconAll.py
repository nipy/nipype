...
from ..longitudinal import LongReconAll


def test_LongReconAll_inputs():
    input_map = dict(
        FLAIR_file=dict(
            argstr="-FLAIR %s",
            extensions=None,
    ...
    inputs = LongReconAll.input_spec()
...
def test_LongReconAll_outputs():
    ...
    outputs = LongReconAll.output_spec()
