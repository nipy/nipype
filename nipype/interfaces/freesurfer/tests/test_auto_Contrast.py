...
def test_Contrast_inputs():
    input_map = dict(
        annotation=dict(extensions=None, mandatory=True),
        args=dict(argstr="%s"),
        copy_inputs=dict(),
        cortex=dict(extensions=None, mandatory=True),
        environ=dict(nohash=True, usedefault=True),
        hemisphere=dict(argstr="--%s-only", mandatory=True),
        orig=dict(extensions=None, mandatory=True),
        rawavg=dict(extensions=None, mandatory=True),
