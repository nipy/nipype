...
def test_MakeSurfaces_inputs():
    input_map = dict(
        ...
        in_T1=dict(argstr="-T1 %s", extensions=None),
        in_aseg=dict(argstr="-aseg %s", extensions=None),
        in_filled=dict(extensions=None, mandatory=True),
        in_label=dict(extensions=None, xor=["noaparc"]),
        in_orig=dict(argstr="-orig %s", extensions=None, mandatory=True),
        ...
        noaparc=dict(argstr="-noaparc", xor=["in_label"]),
        orig_pial=dict(argstr="-orig_pial %s", extensions=None, requires=["in_label"]),
        orig_white=dict(argstr="-orig_white %s", extensions=None),
