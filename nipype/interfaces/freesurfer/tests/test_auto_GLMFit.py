...
def test_GLMFit_inputs():
    ...
    xor=(u'fsgd', u'design', u'one_sample'),
    ),
    diag=dict(),
    ...
    xor=(u'one_sample', u'fsgd', u'design', u'contrast'),
    ),
    pca=dict(argstr='--pca',
    ),
    ...
    weight_file=dict(xor=[u'weighted_ls'],
    ),
    ...
    xor=(u'weight_file', u'weight_inv', u'weight_sqrt'),
    ),
    )
