...
def test_MRISPreprocReconAll_inputs():
    input_map = dict(
        ...
        fwhm=dict(argstr="--fwhm %f", xor=["num_iters"],),
        fwhm_source=dict(argstr="--fwhm-src %f", xor=["num_iters_source"],),
        hemi=dict(argstr="--hemi %s", mandatory=True,),
        lh_surfreg_target=dict(extensions=None, requires=["surfreg_files"],),
        num_iters=dict(argstr="--niters %d", xor=["fwhm"],),
        num_iters_source=dict(argstr="--niterssrc %d", xor=["fwhm_source"],),
        out_file=dict(argstr="--out %s", extensions=None, genfile=True,),
        proj_frac=dict(argstr="--projfrac %s",),
        rh_surfreg_target=dict(extensions=None, requires=["surfreg_files"],),
        ...
        subjects=dict(
            argstr="--s %s...", xor=("subjects", "fsgd_file", "subject_file"),
        ),
        subjects_dir=dict(),
        surf_area=dict(
            argstr="--area %s", xor=("surf_measure", "surf_measure_file", "surf_area"),
        ),
        surf_dir=dict(argstr="--surfdir %s",),
        surf_measure=dict(
            argstr="--meas %s", xor=("surf_measure", "surf_measure_file", "surf_area"),
        ),
        ...
        surfreg_files=dict(
            argstr="--surfreg %s", requires=["lh_surfreg_target", "rh_surfreg_target"],
        ),
        target=dict(argstr="--target %s", mandatory=True,),
