...
def test_SurfaceSnapshots_inputs():
    input_map = dict(
        annot_file=dict(argstr="-annotation %s", extensions=None, xor=["annot_name"]),
        annot_name=dict(argstr="-annotation %s", xor=["annot_file"]),
        args=dict(argstr="%s"),
        colortable=dict(argstr="-colortable %s", extensions=None),
        demean_overlay=dict(argstr="-zm"),
        environ=dict(nohash=True, usedefault=True),
        hemi=dict(argstr="%s", mandatory=True, position=2),
        identity_reg=dict(
            argstr="-overlay-reg-identity",
            xor=["overlay_reg", "identity_reg", "mni152_reg"],
        ),
        invert_overlay=dict(argstr="-invphaseflag 1"),
        label_file=dict(argstr="-label %s", extensions=None, xor=["label_name"]),
        label_name=dict(argstr="-label %s", xor=["label_file"]),
        label_outline=dict(argstr="-label-outline"),
        label_under=dict(argstr="-labels-under"),
        mni152_reg=dict(
            argstr="-mni152reg", xor=["overlay_reg", "identity_reg", "mni152_reg"]
        ),
        orig_suffix=dict(argstr="-orig %s"),
        overlay=dict(argstr="-overlay %s", extensions=None, requires=["overlay_range"]),
        ...
        patch_file=dict(argstr="-patch %s", extensions=None),
        ...
        show_curv=dict(argstr="-curv", xor=["show_gray_curv"]),
        show_gray_curv=dict(argstr="-gray", xor=["show_curv"]),
        six_images=dict(),
        sphere_suffix=dict(argstr="-sphere %s"),
        stem_template_args=dict(requires=["screenshot_stem"]),
        subject_id=dict(argstr="%s", mandatory=True, position=1),
        subjects_dir=dict(),
        surface=dict(argstr="%s", mandatory=True, position=3),
        tcl_script=dict(argstr="%s", extensions=None, genfile=True),
