...
def test_MRIConvert_inputs():
    input_map = dict(
        apply_inv_transform=dict(
            argstr="--apply_inverse_transform %s", extensions=None
        ),
        apply_transform=dict(argstr="--apply_transform %s", extensions=None),
        args=dict(argstr="%s"),
        ascii=dict(argstr="--ascii"),
        autoalign_matrix=dict(argstr="--autoalign %s", extensions=None),
        color_file=dict(argstr="--color_file %s", extensions=None),
        ...
        in_file=dict(
            argstr="--input_volume %s", extensions=None, mandatory=True, position=-2
        ),
        ...
        in_like=dict(argstr="--in_like %s", extensions=None),
        ...
        out_file=dict(
            argstr="--output_volume %s", extensions=None, genfile=True, position=-1
        ),
        ...
        reslice_like=dict(argstr="--reslice_like %s", extensions=None),
        sdcm_list=dict(argstr="--sdcmlist %s", extensions=None),
        ...
        status_file=dict(argstr="--status %s", extensions=None),
