...
def test_SphericalAverage_inputs():
    input_map = dict(
        ...
        fname=dict(argstr="%s", mandatory=True, position=-5),
        hemisphere=dict(argstr="%s", mandatory=True, position=-4),
        in_average=dict(argstr="%s", genfile=True, position=-2),
        in_orig=dict(argstr="-orig %s", extensions=None),
        in_surf=dict(argstr="%s", extensions=None, mandatory=True, position=-3),
        out_file=dict(argstr="%s", extensions=None, genfile=True, position=-1),
        subject_id=dict(argstr="-o %s", mandatory=True),
        subjects_dir=dict(),
        threshold=dict(argstr="-t %.1f"),
        which=dict(argstr="%s", mandatory=True, position=-6),
    )
