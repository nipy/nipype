...
<http://www.fmrib.ox.ac.uk/niftyseg/index.html>`_ command line tools.  This
was written to work with NIFTYSEG version 4.1.4.

These are the base tools for working with NIFTYSEG.
Preprocessing tools are found in niftyseg/preprocess.py
Model tools are found in niftyseg/model.py
DTI tools are found in niftyseg/dti.py
...
class Info(object):
    """Handle niftyseg output type and version information.

    version refers to the version of niftyseg on the system
