...
def test_LabelFusion_inputs():
    input_map = dict(
        args=dict(argstr="%s"),
        classifier_type=dict(argstr="-%s", mandatory=True, position=2),
        conv=dict(argstr="-conv %f"),
        dilation_roi=dict(),
        environ=dict(nohash=True, usedefault=True),
        file_to_seg=dict(extensions=None, mandatory=True),
        ...
        sm_ranking=dict(argstr="-%s", position=3, usedefault=True),
