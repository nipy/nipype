...
def test_Camino2Trackvis_inputs():
    input_map = dict(
        args=dict(argstr="%s"),
        data_dims=dict(argstr="-d %s", mandatory=True, position=4, sep=","),
        environ=dict(nohash=True, usedefault=True),
        in_file=dict(argstr="-i %s", extensions=None, mandatory=True, position=1),
        min_length=dict(argstr="-l %d", position=3, units="mm"),
        nifti_file=dict(argstr="--nifti %s", extensions=None, position=7),
        out_file=dict(argstr="-o %s", extensions=None, genfile=True, position=2),
        voxel_dims=dict(argstr="-x %s", mandatory=True, position=5, sep=","),
        voxel_order=dict(
            argstr="--voxel-order %s", extensions=None, mandatory=True, position=6
        ),
    )
