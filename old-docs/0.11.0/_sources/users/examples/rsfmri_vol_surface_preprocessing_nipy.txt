...
.. _example_rsfmri_vol_surface_preprocessing_nipy:
...
.. admonition:: Example source code
   ...
   You can download :download:`the full source code of this example <../../../examples/rsfmri_vol_surface_preprocessing_nipy.py>`.
