...
createnodes.inputs.resolution_network_file = cmp_config._get_lausanne_parcellation(
...
mapping.connect([(eddycorrect, estimateresponse, [("outputnode.eddy_corrected",
                                                   "in_file")])])
