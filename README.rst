...
If you have a problem or would like to ask a question about how to do something in Nipype please open an issue to [NeuroStars.org](http://neurostars.org) with a *nipype* tag.  [NeuroStars.org](http://neurostars.org) is a platform similar to StackOverflow but dedicated to neuroinformatics.
