...
You've discovered a bug or something else you want to change in Nipype_ - excellent!
...
Then, send the generated patch files to the `Nipype mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the Nipype_ repository::
...
#. Finally, make your commits into patches.  You want all the commits
   ...
   Send these files to the `Nipype mailing list`_.
...
Fork the Nipype_ repository on github_ - :ref:`forking`.  Then::
   ...
   git remote add origin git@github.com:your-user-name/nipype.git
